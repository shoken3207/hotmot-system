...
//			if(categoryId != "" && Integer.parseInt(categoryId) != Const.ProductCategories.ALL.getValue()) {
//				int parseCategoryId = Integer.parseInt(categoryId);
//				bookMarks = bookMarkDao.findCategoryBookMarksByUserId(parseUserId, parseCategoryId);
//			}else {
//				bookMarks =  bookMarkDao.findBookMarksByUserId(parseUserId);
//			}
